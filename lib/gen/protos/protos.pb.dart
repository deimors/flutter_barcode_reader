...
class AndroidConfiguration extends $pb.GeneratedMessage {
  ...
  'Will be removed in next major version')
  AndroidConfiguration copyWith(void Function(AndroidConfiguration) updates) => super.copyWith((message) => updates(message as AndroidConfiguration)); // ignore: deprecated_member_use
